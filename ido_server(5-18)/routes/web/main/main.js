...
exports.contents = function(req, res){
	...
	client.query('SELECT CONTENTS_ID, TITLE, THUMBNAIL_IMAGE_PATH, CATEGORY, IMAGE_TYPE, DATE_FORMAT(REG_DATE, "%Y.%m.%d") REG_DATE FROM ido_contents_tb ORDER BY CONTENTS_ID DESC LIMIT ?, 6', parseInt(reqNo) , function(error, rst){
