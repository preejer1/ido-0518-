...
DROP TABLE SURVEY_ANSWER_RANK;
DROP TABLE SURVEY_ANSWER_SELECT;
...
#ANSWER
CREATE TABLE SURVEY_ANSWER_TB(SURVEY_ANSWER_ID MEDIUMINT NOT NULL AUTO_INCREMENT, SURVEY_ID MEDIUMINT NOT NULL, SURVEY_TYPE_ID SMALLINT NOT NULL, SURVEY_CONTENTS_ID SMALLINT NOT NULL, SURVEY_TYPE SMALLINT NOT NULL, USER_ID MEDIUMINT NOT NULL, ANSWER VARCHAR(50) NULL, PRIMARY KEY(SURVEY_ANSWER_ID), FOREIGN KEY(SURVEY_TYPE_ID) REFERENCES SURVEY_TYPE_TB(SURVEY_TYPE_ID), FOREIGN KEY(SURVEY_CONTENTS_ID) REFERENCES SURVEY_CONTENTS_TB(SURVEY_CONTENTS_ID));



#ANSWER[순위형]
CREATE TABLE SURVEY_ANSWER_RANK(ANSWER_RANK_ID MEDIUMINT NOT NULL AUTO_INCREMENT, SURVEY_ID MEDIUMINT, SURVEY_TYPE_ID SMALLINT NOT NULL, USER_ID MEDIUMINT NOT NULL, SURVEY_CONTENTS_ID MEDIUMINT NOT NULL, RANK SMALLINT NOT NULL, PRIMARY KEY(ANSWER_RANK_ID));
#ANSWER[선택형]
CREATE TABLE SURVEY_ANSWER_SELECT(ANSWER_SELECT_ID MEDIUMINT NOT NULL AUTO_INCREMENT, SURVEY_ID MEDIUMINT, SURVEY_TYPE_ID SMALLINT NOT NULL, USER_ID MEDIUMINT NOT NULL, SURVEY_CONTENTS_ID MEDIUMINT NOT NULL, PRIMARY KEY(ANSWER_SELECT_ID));
